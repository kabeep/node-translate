...
const example1 =
    '[[["example","例子",null,null,10],[null,null,null,"Lìzi"]],[["noun",["example","case","instance"],[["example",["例","例子","范例","榜样","典范","例证"],null,0.2649736],["case",["外壳","例","案件","案","壳体","例子"],null,0.015666196],["instance",["例子","例","事例","比方","详","故"],null,0.0037210477]],"例子",1]],"zh-CN",null,null,[["例子",null,[["example",1000,true,false,[10,3],null,[[3]]],["examples",0,true,false,[8]]],[[0,2]],"例子",0,0]],1,[],[["zh-CN"],null,[1],["zh-CN"]]]';

test('parse - should parse the synonyms for response body', async () => {
    const result = parse(JSON.parse(example1));
    const expected = ['例', '例子', '范例', '榜样', '典范', '例证'];
    expect(result.from.synonyms).toStrictEqual(expected);
});

const example2 =
    '[[["example","example",null,null,3,null,null,[[]],[[["af64405095a399ceb1e05c7abb7cda66","zh_en_2023q1.md"]]]]],null,"zh-CN",null,null,[["example",null,[["example",0,true,false,[3],null,[[3]]],["Example",0,true,false,[8]]],[[0,7]],"example",0,0]],1,[],[["en"],null,[1],["en"]]]';
...
const example4 =
    '[[["谢谢你","Thunk you",null,null,3,null,null,[[]],[[["6ffafab0da7e640be86ac09d0d5e539c","en_zh_2023q1.md"]]]],[null,null,"Xièxiè nǐ"]],null,"en",null,null,[["Thunk you",null,[["谢谢你",0,true,false,[3],null,[[3]]],["谢谢您",0,true,false,[8]]],[[0,9]],"Thunk you",0,0]],1,["<b><i>Thank</i></b> you","Thank you",[1],null,null,false],[["en"],null,[1],["en"]]]';
...
test('parse - should return error object if parameter is exceptional', async () => {
    try {
        ...
        expect((err as Error).message).toBe('EPARSE');
    }
});
